...
import {
    ...
    SetEmail,
    SetPassword
} from '@/redux/admin/login/slice'
import { submit } from '@/redux/admin/login/action'
...
const AdminLoginPage: React.FC = () => {
    const StateAdminLogin = useAppSelector(AdminLoginState)
        ...
        <Container>
            <CardLogin>
                ...
                <RightPanel>
                    ...
                    <InputTextIcon
                        icon='bx bx-envelope'
                        value={StateAdminLogin.Email}
                        placeholder='email'
                        onChange={onChangeEmail}
                    />
                    <InputPasswordIcon
                        value={StateAdminLogin.Password}
                    ...
                    <ButtonLogin
                        onClick={() => { onSubmit() }}
                        onLoading={StateAdminLogin.LoadingLogin}
                    >
                        Login
                    </ButtonLogin>
                </RightPanel>
